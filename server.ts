...
import { obtenerTodasLasTareas, obtenerTareaPorId, crearNuevaTarea, eliminarTareaPorId, actualizarTareaPorId, completarTareaPorId, obtenerTodasLasTareasCompletadas, obtenerTareaCompletadaPorId } from './src/server/utils.ts'
...
app.get('/tareascompletadas/:id', obtenerTareaCompletadaPorId)
